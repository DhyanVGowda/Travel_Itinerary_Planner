...
VALUES 
('example1@example.com', '1234567890', 'John', 'Doe', 'Male', '1990-01-01', 101, 'Main St', 123, 'City1', 'State1', '12345'),
('example2@example.com', '9876543210', 'Jane', 'Doe', 'Female', '1992-03-15', 202, 'Broadway', 456, 'City2', 'State2', '67890'),
('example3@example.com', '1112223333', 'Alice', 'Smith', 'Female', '1985-06-20', 303, 'Park Ave', 789, 'City3', 'State3', '34567'),
('example4@example.com', '4445556666', 'Bob', 'Johnson', 'Male', '1978-11-10', 404, 'Oak St', 1011, 'City4', 'State4', '89012'),
('example5@example.com', '7778889999', 'Emily', 'Brown', 'Female', '2000-09-25', 505, 'Cedar St', 1213, 'City5', 'State5', '23456');

-- Dummy data for Trip table
INSERT INTO Trip (trip_name, start_date, end_date, trip_status)
VALUES 
('Trip 1', '2024-05-01', '2024-05-10', 'Planning In Progress'),
...
VALUES 
('2024-05-02', 'Food', 'Dinner at a restaurant', 50.00, 'USD', 1),
...
VALUES 
('Destination 1', 'Country1', '2024-05-01', '2024-05-10'),
...
VALUES 
('Activity 1', 'Description 1', '2024-05-02', '09:00:00', '12:00:00', 30.00, 1),
...
VALUES 
(1, 'Museum', 'Description of museum sightseeing'),
(2, 'Historical Site', 'Description of historical site visit'),
(3, 'City Tour', 'Description of city tour'),
(4, 'Nature Walk', 'Description of nature walk'),
...
VALUES 
(2, 'Hiking', 12, 'No other restrictions'),
(4, 'Rock Climbing', 15, 'Experience required'),
(5, 'Surfing', 18, 'Swimming skills required');
...
VALUES 
('HomeStay 1', 50.00, '1112223333', '2024-05-01', '2024-05-10', 'Main St', '456', 'City1', 'State1', '12345', 1, 2, 1, 'Entire Home', 0),
('HomeStay 2', 60.00, '4445556666', '2024-06-15', '2024-06-25', 'Broadway', '789', 'City2', 'State2', '67890', 2, 3, 0, 'Private Room', 1),
('HomeStay 3', 70.00, '7778889999', '2024-07-01', '2024-07-10', 'Park Ave', '1011', 'City3', 'State3', '34567', 3, 1, 1, 'Shared Room', 0),
('HomeStay 4', 80.00, '9990001111', '2024-08-15', '2024-08-25', 'Oak St', '1213', 'City4', 'State4', '89012', 4, 2, 0, 'Entire Home', 1),
('HomeStay 5', 90.00, '1231231234', '2024-09-01', '2024-09-10', 'Cedar St', '1415', 'City5', 'State5', '23456', 5, 3, 1, 'Private Room', 0);
...
VALUES 
('Hotel 1', 100.00, '2223334444', '2024-05-01', '2024-05-10', 'Main St', '101', 'City1', 'State1', '12345', 1, 2, 1, '3'),
('Hotel 2', 120.00, '5556667777', '2024-06-15', '2024-06-25', 'Broadway', '202', 'City2', 'State2', '67890', 2, 3, 0, '4'),
('Hotel 3', 140.00, '8889990000', '2024-07-01', '2024-07-10', 'Park Ave', '303', 'City3', 'State3', '34567', 3, 1, 1, '5'),
('Hotel 4', 160.00, '1112223333', '2024-08-15', '2024-08-25', 'Oak St', '404', 'City4', 'State4', '89012', 4, 2, 0, '4'),
('Hotel 5', 180.00, '4445556666', '2024-09-01', '2024-09-10', 'Cedar St', '505', 'City5', 'State5', '23456', 5, 3, 1, '3');
...
VALUES 
('Hostel 1', 20.00, '1231231234', '2024-05-01', '2024-05-10', 'Main St', '303', 'City1', 'State1', '12345', 1, 1, 'Shared', 1, 1),
('Hostel 2', 25.00, '4564564567', '2024-06-15', '2024-06-25', 'Broadway', '404', 'City2', 'State2', '67890', 2, 1, 'Private', 1, 0),
('Hostel 3', 30.00, '7897897890', '2024-07-01', '2024-07-10', 'Park Ave', '505', 'City3', 'State3', '34567', 3, 1, 'Shared', 1, 1),
('Hostel 4', 35.00, '0120120123', '2024-08-15', '2024-08-25', 'Oak St', '606', 'City4', 'State4', '89012', 4, 1, 'Private', 1, 0),
('Hostel 5', 40.00, '3453453456', '2024-09-01', '2024-09-10', 'Cedar St', '707', 'City5', 'State5', '23456', 5, 1, 'Shared', 1, 1);
